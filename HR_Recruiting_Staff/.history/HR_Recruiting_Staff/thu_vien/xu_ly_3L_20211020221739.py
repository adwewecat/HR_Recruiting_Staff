                                      ...
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <div class="modal-note">
                                            ...
                                            <label for="so_luong_thuc_te">Số Lượng Người Thực Tế Tuyển Được</label>
                                              <input class="nha_hang_bantin_new__soluong-thuc-item" type="number" min="1" name="so_luong_thuc_te" id='
