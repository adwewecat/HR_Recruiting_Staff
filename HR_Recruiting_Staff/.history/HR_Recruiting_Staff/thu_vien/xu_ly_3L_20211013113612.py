...
def CHUOI_HTML_INDEX_BRAND():
    ...
    sql = 'SELECT id,ten_brand,img FROM [dbo].[Brand] where active=1 order by stt'
        ...
        for item in danh_sach:
            ...
            <a href="/" class="block__product">
              <div class="block__product-img">
                <img
                 style="background-image: url(/static/images/'/logos/kpub.svg');"
                  src="./images/logos/kpub.svg')"
                  alt=""
