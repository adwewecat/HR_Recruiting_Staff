                                        ...
                                        <div class="modal-body">
                                          <div class="modal-note">
                                            ...
                                            Số Lượng Người Thực Tế Tuyển Được
                                              <input class="nha_hang_bantin_new__soluong-thuc-item" type="number" min="1" name="soluong_thuc_te" id="so_luong_thuc_te"
                                                placeholder="Số Lượng Người Thực Tế Tuyển Được" value="'''+str(STAFF_QUANTITY)+'''" required>
                                            </div>
                                            <input name='id_bai_dang_hoan_thanh' type="text" value="'''+str(ID)+'''" hidden>
                                          </div>
                                        </div>
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
def INSERT_BAN_TIN_NHA_HANG(restaurant_id,brand_id,district_id,region_id,note,time_from,time_to,staff_quantity,user_dang_bai):
    list_danh_sach =''
    connection_2014 = connect_database_SQL_2014()
    if connection_2014 != '1':
      conn_2014 = connection_2014.cursor()
      sql = "INSERT INTO Newpost\
            ...
            "
      conn_2014.execute(sql,(restaurant_id,brand_id,district_id,region_id,note,time_from,time_to,staff_quantity,user_dang_bai))  
      conn_2014.commit()
      conn_2014.close()
      list_danh_sach = '''<div class="alert alert-success" role="alert">
        ...
        list_danh_sach =' <h1> Lỗi Kết Nối Đến Server <h1>'
    return Markup(list_danh_sach)
# =============================== INSERT BẢN TIN NHÀ HÀNG END ===============================
# =================




# =============================== UPDATE HOÀN THÀNH BÀI ĐĂNG Start ===============================
def UPDATE_BAN_TIN_NHA_HANG(id_bai_dang,staff_quantity_thucte,ngay_hoanthanh):
    list_danh_sach =''
    connection_2014 = connect_database_SQL_2014()
    if connection_2014 != '1':
      conn_2014 = connection_2014.cursor()
      sql = "UPDATE [dbo].[Newpost] SET\
            active = 0,\
            staff_quantity_thucte = ?,\
            ngay_hoan_thanh = ?\
            where id=?\
            "
      conn_2014.execute(sql,(staff_quantity_thucte,ngay_hoanthanh,id_bai_dang))  
      conn_2014.commit()
      conn_2014.close()
      list_danh_sach = '''<div class="alert alert-success" role="alert">
                          Hoàn Thành Bài Đăng Thành Công
                        </div>'''

    else:
        list_danh_sach =' <h1> Lỗi Kết Nối Đến Server <h1>'
    return Markup(list_danh_sach)
# =============================== UPDATE HOÀN THÀNH BÀI ĐĂNG END ===============================
# =================
