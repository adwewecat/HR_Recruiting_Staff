    ...
    if connection_2014 != '1':
      ...
      if danh_sach is not None:
          for item in danh_sach:
              ...
              list_danh_sach +='''
                      <div class="l-6 c-12">
                        <a class="nha_hang_danh_sach__new-item" type="button" data-toggle="modal"
                          data-target="#ban_tin">
                      ...
                      <!-- Modal Start-->
                      <div class="modal fade" id="ban_tin" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-body">
                              <div class="modal-note">
                                <div class="nha_hang_bantin_new__soluong-thuc">
                                  <input class="nha_hang_bantin_new__soluong-thuc-item" type="number" min="1"
                                    placeholder="Số Lượng Người Thực Tế Tuyển Được" required>
                                </div>
                                <input name='ID' type="text" value="123" hidden>
                              </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
