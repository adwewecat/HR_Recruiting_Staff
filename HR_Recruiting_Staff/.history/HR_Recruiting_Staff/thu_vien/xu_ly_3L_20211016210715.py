...
import os
import sqlite3
# from GGG.thu_vien.xu_ly_3L import *
...
def CHUOI_HTML_INDEX_BRAND():
    ...
    if connection_2014 != '1':
      ...
      sql = 'SELECT id,ten_viet_tat,img FROM [dbo].[Brand] where active=1 order by stt'
                          ...
                          <a href="/'''+str(TEN_VIET_TAT)+'''" class="block__product">
                            ...
                            <div class="block__product-content">
                              <div class="block__product-content-item">
                                <span>Số Người Cần Tuyển : 20 </span>
                              </div>
                            </div>
                          </a>
                          </div>
    ...
    if connection_2014 != '1':
      ...
      if danh_sach is not None:
          for item in danh_sach:
              ...
              STAFF_QUANTITY = item[6]
              NOTE = item[7]
              SDT = item[8]
              ADDRESS = item[9]
              list_danh_sach +='''
                            <div class="col l-6 m-6 c-12">
                              <a class="new__post-item-link" data-toggle="modal" data-target="#exampleModalCenter">
                                  <div class="new__post-item-img">
                                  <img src="{{url_for('static', filename = 'images/logos/hutong.svg')}}" alt="" class="new__post-item-img-link">
                                  </div>
                                  <div class="new__post-content-list">
                                    <div class="new__post-content-item-res">
                                      <span class=" new__post-content-item new__post-content-item-name">Hutong Nguyễn Tri Phương Hồ Chí Minh</span>
                                    </div>
                                    <div class="new__post-content-list-comment">
                                      <div class="new__post-content-list-time">
                                        ...
                                        <span class="new__post-content-list-comment-item">14:00</span>
                                        <span class="new__post-content-list-comment-item">
                                          <i class="fas fa-arrow-right"></i>
                                        </span>
                                        <span class="new__post-content-list-comment-item">18:00</span>
                                      </div>
                                      <div class="new__post-content-list-comment-item-quantity">
                                        <span class="new__post-content-list-comment-item">Địa Điểm : Quận 5 / HCM</span>
                                        <span class="new__post-content-list-comment-item quantity-cach-le">Số Lượng Cần : 55 </span>
                                      </div>
                                    </div>
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Hutong Nguyễn Tri Phương</h5>
                                      ...
                                      <div class="modal-body">
                                        <div class="modal-note">
                                          <span>Ghi Chú : Cần 5 Phục Vụ , 1 Pha Chế</span>
                                        </div>
                                        <div class="modal-address">
                                          <span>Liên Hệ : <a href="tel:+4733378901">+47 333 78 901</a></span>
                                        </div>
                                        <div class="">
                                          <span>Địa Chỉ : 134 Nguyen Tri Phuong, Phuong 9, Quan 5, Ho Chi Minh</span>
                                        </div>
                                      </div>
