...
connection_2014 = connect_database_SQL_2014()
    ...
    # print(conn_2014)
    sql = 'SELECT TOP 1 id,ten_file_luu,data FROM UPLOAD_FILE_MANAGERMENT WHERE user_them = ? AND id =?'
    conn_2014.execute(sql,(userthem,_id,))  
...
def hr():
    ...
    return render_template('USER_HR/index.html')