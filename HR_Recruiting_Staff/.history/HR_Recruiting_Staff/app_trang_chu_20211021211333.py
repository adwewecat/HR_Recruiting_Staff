...
def nha_hang():
    ...
    if request.form.get('so_luong_thuc_te_bai_dang_hoan_thanh'):
        so_luong_thuc_te_bai_dang_hoan_thanh = request.form.get('so_luong_thuc_te_bai_dang_hoan_thanh')
        id_bai_dang_hoan_thanh =request.form.get('id_bai_dang_hoan_thanh') 

        print(so_luong_thuc_te_bai_dang_hoan_thanh ,id_bai_dang_hoan_thanh )
