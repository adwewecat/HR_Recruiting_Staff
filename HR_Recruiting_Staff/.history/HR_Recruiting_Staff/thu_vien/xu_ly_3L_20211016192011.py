    ...
    if connection_2014 != '1':
      ...
      if danh_sach is not None:
          for item in danh_sach:
            ...
            <a href="/" class="block__product">
              <div class="block__product-img">
                <img
                  src="{{url_for('static', filename = 'images/logos/hutong.svg')}}"
                  alt=""
        ...
        list_danh_sach =' <div class="col l-3 m-6 c-12"><h1> Lỗi Kết Nối Đến Server <h1></div>'
