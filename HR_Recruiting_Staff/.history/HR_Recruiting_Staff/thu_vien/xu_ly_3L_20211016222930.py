                                  ...
                                  <div class="new__post-content-list">
                                    ...
                                    <div class="new__post-content-list-comment">
                                      <div class="new__post-content-list-time">
                                        ...
                                        <span class="new__post-content-list-comment-item">'''+H_TIME_FROM+''':'''+M_TIME_FROM+'''</span>
                                        <span class="new__post-content-list-comment-item">
                                          <i class="fas fa-arrow-right"></i>
                                        </span>
                                        <span class="new__post-content-list-comment-item">'''+H_TIME_TO+''':'''+str(M_TIME_TO+'''</span>
                                      </div>
                                      <div class="new__post-content-list-comment-item-quantity">
                                        ...
                                        <span class="new__post-content-list-comment-item quantity-cach-le">Số Lượng Cần : '''+str(STAFF_QUANTITY)+''' </span>
                                      </div>
                                    </div>
