...
def nha_hang():
    chuoi_html_nha_hang_thong_tin=''
    chuoi_dang_xuat=''
    chuoi_html_ban_tin_con_su_dung = ''
    ...
    if request.form.get('nhahang_dangtin_soluong'):
        ...
        print(chuoi_html_ban_tin_hoan_thanh)
    ...
    if session.get('session_id_nha_hang') is not None:
        ...
        if phancap == 'nhahang':
            ...
            session['session_chuoi_html_nha_hang_thong_tin'] = chuoi_dang_xuat
            session['session_chuoi_html_ban_tin_hoan_thanh'] = chuoi_dang_xuat
