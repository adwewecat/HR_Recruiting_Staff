...
def nha_hang():
    ...
    if request.form.get('nhahang_dangtin_soluong'):
        ...
        nhahang_dangtin_gio_from =request.form.get('nhahang_dangtin_soluong') 
        nha_hang_create__gio-den = request.form.get('nhahang_dangtin_soluong')
        nhahang_dangtin_note_vitri = request.form.get('nhahang_dangtin_soluong')
