...
def INSERT_BAN_TIN_NHA_HANG(id_bai_dang,staff_quantity_thucte,ngay_hoanthanh):
    list_danh_sach =''
    connection_2014 = connect_database_SQL_2014()
    if connection_2014 != '1':
      conn_2014 = connection_2014.cursor()
      sql = "UPDATE [dbo].[Newpost] SET\
            ...
            where id=?\
            "
      conn_2014.execute(sql,(id_bai_dang,staff_quantity_thucte,ngay_hoanthanh))  
      conn_2014.commit()
      conn_2014.close()
      list_danh_sach = '''<div class="alert alert-success" role="alert">
                          Hoàn Thành Bài D Tin Mới Thành Công
                        </div>'''
